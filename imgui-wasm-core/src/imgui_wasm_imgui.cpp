...
CIMGUI_API void        cimgui::igShowIDStackToolWindow(bool* p_open)
{
...
CIMGUI_API void cimgui::igSetNextWindowPos(cimgui::ImVec2 pos, ImGuiCond cond, cimgui::ImVec2 pivot)
{
...
CIMGUI_API void cimgui::igPopStyleColor(int count)
{
...
CIMGUI_API void cimgui::igPopStyleVar(int count)
{
...
CIMGUI_API ImU32         cimgui::igGetColorU32(ImGuiCol idx, float alpha_mul)
{
...
CIMGUI_API ImU32         cimgui::igGetColorU32ImU32(ImU32 col, float alpha_mul)
{
...
CIMGUI_API void  cimgui::igSameLine(float offset_from_start_x, float spacing)
{
...
CIMGUI_API void  cimgui::igIndent(float indent_w)
{
    ::ImGui::Indent(indent_w);
}

CIMGUI_API void  cimgui::igUnindent(float indent_w)
{
...
CIMGUI_API void cimgui::igTextUnformatted(const char* text, const char* text_end)
{
...
CIMGUI_API bool cimgui::igButton(const char* label, cimgui::ImVec2 size)
{
...
CIMGUI_API bool cimgui::igTextLinkOpenURL(const char* label, const char* url)
{
    return ::ImGui::TextLinkOpenURL(label, url);
}

CIMGUI_API void cimgui::igImage(cimgui::ImTextureRef tex_ref, cimgui::ImVec2 image_size, cimgui::ImVec2 uv0, cimgui::ImVec2 uv1)
{
...
CIMGUI_API void cimgui::igImageWithBg(cimgui::ImTextureRef tex_ref, cimgui::ImVec2 image_size, cimgui::ImVec2 uv0, cimgui::ImVec2 uv1, cimgui::ImVec4 bg_col, cimgui::ImVec4 tint_col)
{
...
CIMGUI_API bool cimgui::igImageButton(const char* str_id, cimgui::ImTextureRef tex_ref, cimgui::ImVec2 image_size, cimgui::ImVec2 uv0, cimgui::ImVec2 uv1, cimgui::ImVec4 bg_col, cimgui::ImVec4 tint_col)
{
...
CIMGUI_API bool cimgui::igComboChar(const char* label, int* current_item, const char*const items[], int items_count, int popup_max_height_in_items)
{
    return ::ImGui::Combo(label, current_item, items, items_count, popup_max_height_in_items);
}

CIMGUI_API bool cimgui::igCombo(const char* label, int* current_item, const char* items_separated_by_zeros, int popup_max_height_in_items)
{
    return ::ImGui::Combo(label, current_item, items_separated_by_zeros, popup_max_height_in_items);
}

CIMGUI_API bool cimgui::igComboCallback(const char* label, int* current_item, const char* (*getter)(void* user_data, int idx), void* user_data, int items_count, int popup_max_height_in_items)
{
    return ::ImGui::Combo(label, current_item, getter, user_data, items_count, popup_max_height_in_items);
}

CIMGUI_API bool cimgui::igDragFloat(const char* label, float* v, float v_speed, float v_min, float v_max, const char* format, ImGuiSliderFlags flags)
{
    return ::ImGui::DragFloat(label, v, v_speed, v_min, v_max, format, flags);
}

CIMGUI_API bool cimgui::igDragFloat2(const char* label, float v[2], float v_speed, float v_min, float v_max, const char* format, ImGuiSliderFlags flags)
{
    return ::ImGui::DragFloat2(label, v, v_speed, v_min, v_max, format, flags);
}

CIMGUI_API bool cimgui::igDragFloat3(const char* label, float v[3], float v_speed, float v_min, float v_max, const char* format, ImGuiSliderFlags flags)
{
    return ::ImGui::DragFloat3(label, v, v_speed, v_min, v_max, format, flags);
}

CIMGUI_API bool cimgui::igDragFloat4(const char* label, float v[4], float v_speed, float v_min, float v_max, const char* format, ImGuiSliderFlags flags)
{
    return ::ImGui::DragFloat4(label, v, v_speed, v_min, v_max, format, flags);
}

CIMGUI_API bool cimgui::igDragFloatRange2(const char* label, float* v_current_min, float* v_current_max, float v_speed, float v_min, float v_max, const char* format, const char* format_max, ImGuiSliderFlags flags)
{
    return ::ImGui::DragFloatRange2(label, v_current_min, v_current_max, v_speed, v_min, v_max, format, format_max, flags);
}

CIMGUI_API bool cimgui::igDragInt(const char* label, int* v, float v_speed, int v_min, int v_max, const char* format, ImGuiSliderFlags flags)
{
    return ::ImGui::DragInt(label, v, v_speed, v_min, v_max, format, flags);
}

CIMGUI_API bool cimgui::igDragInt2(const char* label, int v[2], float v_speed, int v_min, int v_max, const char* format, ImGuiSliderFlags flags)
{
    return ::ImGui::DragInt2(label, v, v_speed, v_min, v_max, format, flags);
}

CIMGUI_API bool cimgui::igDragInt3(const char* label, int v[3], float v_speed, int v_min, int v_max, const char* format, ImGuiSliderFlags flags)
{
    return ::ImGui::DragInt3(label, v, v_speed, v_min, v_max, format, flags);
}

CIMGUI_API bool cimgui::igDragInt4(const char* label, int v[4], float v_speed, int v_min, int v_max, const char* format, ImGuiSliderFlags flags)
{
    return ::ImGui::DragInt4(label, v, v_speed, v_min, v_max, format, flags);
}

CIMGUI_API bool cimgui::igDragIntRange2(const char* label, int* v_current_min, int* v_current_max, float v_speed, int v_min, int v_max, const char* format, const char* format_max, ImGuiSliderFlags flags)
{
    return ::ImGui::DragIntRange2(label, v_current_min, v_current_max, v_speed, v_min, v_max, format, format_max, flags);
}

CIMGUI_API bool cimgui::igDragScalar(const char* label, ImGuiDataType data_type, void* p_data, float v_speed, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags)
{
    return ::ImGui::DragScalar(label, data_type, p_data, v_speed, p_min, p_max, format, flags);
}

CIMGUI_API bool cimgui::igDragScalarN(const char* label, ImGuiDataType data_type, void* p_data, int components, float v_speed, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags)
{
    return ::ImGui::DragScalarN(label, data_type, p_data, components, v_speed, p_min, p_max, format, flags);
}

CIMGUI_API bool cimgui::igSliderFloat(const char* label, float* v, float v_min, float v_max, const char* format, ImGuiSliderFlags flags)
{
    return ::ImGui::SliderFloat(label, v, v_min, v_max, format, flags);
}

CIMGUI_API bool cimgui::igSliderFloat2(const char* label, float v[2], float v_min, float v_max, const char* format, ImGuiSliderFlags flags)
{
    return ::ImGui::SliderFloat2(label, v, v_min, v_max, format, flags);
}

CIMGUI_API bool cimgui::igSliderFloat3(const char* label, float v[3], float v_min, float v_max, const char* format, ImGuiSliderFlags flags)
{
    return ::ImGui::SliderFloat3(label, v, v_min, v_max, format, flags);
}

CIMGUI_API bool cimgui::igSliderFloat4(const char* label, float v[4], float v_min, float v_max, const char* format, ImGuiSliderFlags flags)
{
    return ::ImGui::SliderFloat4(label, v, v_min, v_max, format, flags);
}

CIMGUI_API bool cimgui::igSliderAngle(const char* label, float* v_rad, float v_degrees_min, float v_degrees_max, const char* format, ImGuiSliderFlags flags)
{
    return ::ImGui::SliderAngle(label, v_rad, v_degrees_min, v_degrees_max, format, flags);
}

CIMGUI_API bool cimgui::igSliderInt(const char* label, int* v, int v_min, int v_max, const char* format, ImGuiSliderFlags flags)
{
    return ::ImGui::SliderInt(label, v, v_min, v_max, format, flags);
}

CIMGUI_API bool cimgui::igSliderInt2(const char* label, int v[2], int v_min, int v_max, const char* format, ImGuiSliderFlags flags)
{
    return ::ImGui::SliderInt2(label, v, v_min, v_max, format, flags);
}

CIMGUI_API bool cimgui::igSliderInt3(const char* label, int v[3], int v_min, int v_max, const char* format, ImGuiSliderFlags flags)
{
    return ::ImGui::SliderInt3(label, v, v_min, v_max, format, flags);
}

CIMGUI_API bool cimgui::igSliderInt4(const char* label, int v[4], int v_min, int v_max, const char* format, ImGuiSliderFlags flags)
{
    return ::ImGui::SliderInt4(label, v, v_min, v_max, format, flags);
}

CIMGUI_API bool cimgui::igSliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags)
{
    return ::ImGui::SliderScalar(label, data_type, p_data, p_min, p_max, format, flags);
}

CIMGUI_API bool cimgui::igSliderScalarN(const char* label, ImGuiDataType data_type, void* p_data, int components, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags)
{
    return ::ImGui::SliderScalarN(label, data_type, p_data, components, p_min, p_max, format, flags);
}

CIMGUI_API bool cimgui::igVSliderFloat(const char* label, cimgui::ImVec2 size, float* v, float v_min, float v_max, const char* format, ImGuiSliderFlags flags)
{
    return ::ImGui::VSliderFloat(label, ConvertToCPP_ImVec2(size), v, v_min, v_max, format, flags);
}

CIMGUI_API bool cimgui::igVSliderInt(const char* label, cimgui::ImVec2 size, int* v, int v_min, int v_max, const char* format, ImGuiSliderFlags flags)
{
    return ::ImGui::VSliderInt(label, ConvertToCPP_ImVec2(size), v, v_min, v_max, format, flags);
}

CIMGUI_API bool cimgui::igVSliderScalar(const char* label, cimgui::ImVec2 size, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags)
{
    return ::ImGui::VSliderScalar(label, ConvertToCPP_ImVec2(size), data_type, p_data, p_min, p_max, format, flags);
}

CIMGUI_API bool cimgui::igInputText(const char* label, char* buf, size_t buf_size, ImGuiInputTextFlags flags, cimgui::ImGuiInputTextCallback callback, void* user_data)
{
    return ::ImGui::InputText(label, buf, buf_size, flags, reinterpret_cast<::ImGuiInputTextCallback>(callback), user_data);
}

CIMGUI_API bool cimgui::igInputTextMultiline(const char* label, char* buf, size_t buf_size, cimgui::ImVec2 size, ImGuiInputTextFlags flags, cimgui::ImGuiInputTextCallback callback, void* user_data)
{
...
CIMGUI_API bool cimgui::igInputTextWithHint(const char* label, const char* hint, char* buf, size_t buf_size, ImGuiInputTextFlags flags, cimgui::ImGuiInputTextCallback callback, void* user_data)
{
    return ::ImGui::InputTextWithHint(label, hint, buf, buf_size, flags, reinterpret_cast<::ImGuiInputTextCallback>(callback), user_data);
}

CIMGUI_API bool cimgui::igInputFloat(const char* label, float* v, float step, float step_fast, const char* format, ImGuiInputTextFlags flags)
{
    return ::ImGui::InputFloat(label, v, step, step_fast, format, flags);
}

CIMGUI_API bool cimgui::igInputFloat2(const char* label, float v[2], const char* format, ImGuiInputTextFlags flags)
{
    return ::ImGui::InputFloat2(label, v, format, flags);
}

CIMGUI_API bool cimgui::igInputFloat3(const char* label, float v[3], const char* format, ImGuiInputTextFlags flags)
{
    return ::ImGui::InputFloat3(label, v, format, flags);
}

CIMGUI_API bool cimgui::igInputFloat4(const char* label, float v[4], const char* format, ImGuiInputTextFlags flags)
{
    return ::ImGui::InputFloat4(label, v, format, flags);
}

CIMGUI_API bool cimgui::igInputInt(const char* label, int* v, int step, int step_fast, ImGuiInputTextFlags flags)
{
...
CIMGUI_API bool cimgui::igInputDouble(const char* label, double* v, double step, double step_fast, const char* format, ImGuiInputTextFlags flags)
{
    return ::ImGui::InputDouble(label, v, step, step_fast, format, flags);
}

CIMGUI_API bool cimgui::igInputScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_step, const void* p_step_fast, const char* format, ImGuiInputTextFlags flags)
{
    return ::ImGui::InputScalar(label, data_type, p_data, p_step, p_step_fast, format, flags);
}

CIMGUI_API bool cimgui::igInputScalarN(const char* label, ImGuiDataType data_type, void* p_data, int components, const void* p_step, const void* p_step_fast, const char* format, ImGuiInputTextFlags flags)
{
...
CIMGUI_API bool cimgui::igColorButton(const char* desc_id, cimgui::ImVec4 col, ImGuiColorEditFlags flags, cimgui::ImVec2 size)
{
...
CIMGUI_API bool cimgui::igSelectable(const char* label, bool selected, ImGuiSelectableFlags flags, cimgui::ImVec2 size)
{
    return ::ImGui::Selectable(label, selected, flags, ConvertToCPP_ImVec2(size));
}

CIMGUI_API bool cimgui::igSelectableBoolPtr(const char* label, bool* p_selected, ImGuiSelectableFlags flags, cimgui::ImVec2 size)
{
    return ::ImGui::Selectable(label, p_selected, flags, ConvertToCPP_ImVec2(size));
}

CIMGUI_API cimgui::ImGuiMultiSelectIO* cimgui::igBeginMultiSelect(ImGuiMultiSelectFlags flags, int selection_size, int items_count)
{
...
CIMGUI_API bool cimgui::igListBoxCallback(const char* label, int* current_item, const char* (*getter)(void* user_data, int idx), void* user_data, int items_count, int height_in_items)
{
    return ::ImGui::ListBox(label, current_item, getter, user_data, items_count, height_in_items);
}

CIMGUI_API void cimgui::igPlotLines(const char* label, const float* values, int values_count, int values_offset, const char* overlay_text, float scale_min, float scale_max, cimgui::ImVec2 graph_size, int stride)
{
...
CIMGUI_API void cimgui::igPlotLinesCallback(const char* label, float (*values_getter)(void* data, int idx), void* data, int values_count, int values_offset, const char* overlay_text, float scale_min, float scale_max, cimgui::ImVec2 graph_size)
{
...
CIMGUI_API void cimgui::igPlotHistogram(const char* label, const float* values, int values_count, int values_offset, const char* overlay_text, float scale_min, float scale_max, cimgui::ImVec2 graph_size, int stride)
{
...
CIMGUI_API void cimgui::igPlotHistogramCallback(const char* label, float (*values_getter)(void* data, int idx), void* data, int values_count, int values_offset, const char* overlay_text, float scale_min, float scale_max, cimgui::ImVec2 graph_size)
{
...
CIMGUI_API bool cimgui::igBeginMenu(const char* label, bool enabled)
{
...
CIMGUI_API bool cimgui::igMenuItem(const char* label, const char* shortcut, bool selected, bool enabled)
{
...
CIMGUI_API bool cimgui::igBeginPopupContextItem(const char* str_id, ImGuiPopupFlags popup_flags)
{
    return ::ImGui::BeginPopupContextItem(str_id, popup_flags);
}

CIMGUI_API bool cimgui::igBeginPopupContextWindow(const char* str_id, ImGuiPopupFlags popup_flags)
{
    return ::ImGui::BeginPopupContextWindow(str_id, popup_flags);
}

CIMGUI_API bool cimgui::igBeginPopupContextVoid(const char* str_id, ImGuiPopupFlags popup_flags)
{
...
CIMGUI_API bool cimgui::igBeginTable(const char* str_id, int columns, ImGuiTableFlags flags, cimgui::ImVec2 outer_size, float inner_width)
{
...
CIMGUI_API void cimgui::igTableNextRow(ImGuiTableRowFlags row_flags, float min_row_height)
{
...
CIMGUI_API void cimgui::igTableSetupColumn(const char* label, ImGuiTableColumnFlags flags, float init_width_or_weight, ImGuiID user_id)
{
...
CIMGUI_API void  cimgui::igColumns(int count, const char* id, bool borders)
{
...
CIMGUI_API ImGuiID cimgui::igDockSpace(ImGuiID dockspace_id, cimgui::ImVec2 size, ImGuiDockNodeFlags flags, const cimgui::ImGuiWindowClass* window_class)
{
    return ::ImGui::DockSpace(dockspace_id, ConvertToCPP_ImVec2(size), flags, reinterpret_cast<const ::ImGuiWindowClass*>(window_class));
}

CIMGUI_API ImGuiID cimgui::igDockSpaceOverViewport(ImGuiID dockspace_id, const cimgui::ImGuiViewport* viewport, ImGuiDockNodeFlags flags, const cimgui::ImGuiWindowClass* window_class)
{
...
CIMGUI_API void cimgui::igSetKeyboardFocusHere(int offset)
{
...
CIMGUI_API bool           cimgui::igIsItemClicked(ImGuiMouseButton mouse_button)
{
...
CIMGUI_API cimgui::ImDrawList* cimgui::igGetBackgroundDrawList(cimgui::ImGuiViewport* viewport)
{
    return reinterpret_cast<::cimgui::ImDrawList*>(::ImGui::GetBackgroundDrawList(reinterpret_cast<::ImGuiViewport*>(viewport)));
}

CIMGUI_API cimgui::ImDrawList* cimgui::igGetForegroundDrawList(cimgui::ImGuiViewport* viewport)
{
...
CIMGUI_API cimgui::ImVec2 cimgui::igCalcTextSize(const char* text, const char* text_end, bool hide_text_after_double_hash, float wrap_width)
{
...
CIMGUI_API bool        cimgui::igIsKeyPressed(cimgui::ImGuiKey key, bool repeat)
{
...
CIMGUI_API bool             cimgui::igIsMouseClicked(ImGuiMouseButton button, bool repeat)
{
...
CIMGUI_API bool             cimgui::igIsMouseHoveringRect(cimgui::ImVec2 r_min, cimgui::ImVec2 r_max, bool clip)
{
...
CIMGUI_API void             cimgui::igResetMouseDragDelta(ImGuiMouseButton button)
{
...
CIMGUI_API void           cimgui::igRenderPlatformWindowsDefault(void* platform_render_arg, void* renderer_render_arg)
{
